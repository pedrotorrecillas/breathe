...
export function PlaceholderState({
  ...
  return (
    <section className="ops-beacon relative overflow-hidden rounded-[0.95rem] border border-dashed border-slate-300/80 bg-[linear-gradient(180deg,rgba(250,251,252,0.98),rgba(243,246,249,0.94))] p-6 shadow-[0_12px_28px_rgba(15,23,42,0.04)] md:p-8">
